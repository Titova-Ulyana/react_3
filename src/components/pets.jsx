...
<div>
        ...
        <div className="d-flex flex-row flex-wrap border  border-primary m-auto  p-3 position-relative w-50" style={{'minWidth':'300px'}}>
           <div className="d-flex flex-row flex-wrap justify-content-around border border">
               <img src={chicken1} className="w-25 p-3" style={{'minWidth':'250px'}} alt="Изображения животного"/>
               <img src={chicken2} className="w-25 p-3" style={{'minWidth':'250px'}} alt="Изображения животного"/>
               <img src={chicken3}  className="w-25 p-3" style={{'minWidth':'250px'}} alt="Изображения животного"/>
           </div>
            ...
            <p className="w-50" style={{'minWidth':'300px'}}>Потерялась курица, пятнистая, рыжая. Любит играть, ласковая.</p>
